...
// ── Config Filegarden ──────────────────────────────────
const FILEGARDEN_USER_ID = "6a7589ca8fb510404324bd18";
const FILEGARDEN_AUTH_COOKIE =
  "auth=s%3ANmE3NTg5Y2E4ZmI1MTA0MDQzMjRiZDE4OmRiNWFXWStNcUU1M3Rzeis5d290U0NCSmVaZmQ5VkVCR1RCa21VMFdpakVPaFRiTVBDNGFjQTFyODlpemQ4T3VIdDJlSUl0eThmM3Y4R3BUNVRHaFh4aFl4eTZLeE9INUZScnVRTjk3MDdsZWRjOFVqRFBMR0NqVlAxVWlXR1hkYjF1OVd3PT0%3D.WuU%2FAOwaAQSvXHjNetCv8ltzV8F1Wmuo8am06rioGo0";
const FILEGARDEN_PARENT = "anWKBI-1EEBDJL0h";
...
async function uploadToFilegarden(filePath, filename) {
  ...
  for (let attempt = 1; attempt <= MAX_RETRIES; attempt++) {
    try {
      ...
      const filegardenUrl = `https://file.garden/anWJyo-1EEBDJL0Y/${item.path}`;
      ...
      if (error.response?.status === 422) {
        const existingUrl = `https://file.garden/anWJyo-1EEBDJL0Y/videos/${filename}`;
        console.warn(
